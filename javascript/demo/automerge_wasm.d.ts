 ...
 */
export function setObliviousRef(oc: any): void;
...
export interface InitOutput {
    ...
    readonly automerge_diffPath: (a: number, b: any, c: any, d: any, e: any) => [number, number, number];
    ...
    readonly __wbg_oblivioustext_free: (a: number, b: number) => void;
    readonly oblivioustext_new: (a: number, b: number) => [number, number, number];
    readonly oblivioustext_applyRemoteOp: (a: number, b: number, c: number, d: number, e: any, f: any, g: any, h: any, i: any, j: any, k: any, l: any) => [number, number];
    readonly oblivioustext_getRenderBuffer: (a: number) => [number, number, number];
